...
public:
    ...
    virtual ~B() {printf("B::~B() _id=%d\n", _id);}
    
    virtual int m1(int i, int j) {printf("B::m1() _id=%d\n", _id); f1(i); return 20;}
    virtual int m2(int i) {printf("B::m2() _id=%d\n", _id); f1(i); return 21;}
...
public:
    D() {printf("D::D()\n");}
    D(int i) : B(i) {printf("D::D(int=%d)\n", _id);}
    virtual ~D() {printf("D::~D() _id=%d\n", _id);}
    
    virtual int m1(int i, int j) {printf("D::m1() _id=%d\n", _id); m2(j+10); return 30;}
}; 
